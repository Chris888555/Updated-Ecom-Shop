...
Route::get('/upload-marketing', [MarketingController::class, 'upload'])->name('upload.marketing');
Route::post('/upload-marketing', [MarketingController::class, 'store'])->name('store.marketing');
